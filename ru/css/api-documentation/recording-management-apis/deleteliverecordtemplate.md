...
Этот API используется для удаления шаблона записи.
...
| --- | --- | --- | --- |
| Action | Да | String | [Общие параметры](https://www.tencentcloud.com/document/api/267/30763). Значение, используемое для этого API: DeleteLiveRecordTemplate. |
...
| --- | --- | --- |
| RequestId | String | Уникальный ID запроса, который возвращается для каждого запроса. RequestId требуется для поиска проблемы. |
...
---
*Источник: [https://www.tencentcloud.com/document/product/267/30842](https://www.tencentcloud.com/document/product/267/30842)*

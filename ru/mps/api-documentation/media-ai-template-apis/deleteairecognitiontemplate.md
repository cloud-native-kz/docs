...
Этот API используется для удаления пользовательского шаблона распознавания контента.
...
| --- | --- | --- | --- |
| Action | Да | String | [Общие параметры](https://www.tencentcloud.com/document/api/1041/33628). Значение, используемое для этого API: DeleteAIRecognitionTemplate. |
...
| Definition | Да | Integer | Уникальный ID шаблона распознавания видеоконтента. |
...
### Пример 1. Удаление шаблона распознавания видеоконтента с ID 30

Этот пример показывает, как удалить пользовательский шаблон распознавания видеоконтента.
...
---
*Источник: [https://www.tencentcloud.com/document/product/1041/33669](https://www.tencentcloud.com/document/product/1041/33669)*

---
*Источник (EN): [deleteairecognitiontemplate.md](./deleteairecognitiontemplate.md)*

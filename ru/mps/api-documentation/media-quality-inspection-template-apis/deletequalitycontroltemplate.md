...
Этот API используется для удаления шаблона проверки качества медиа.
...
API Explorer предоставляет диапазон возможностей, включая онлайн-вызов, проверку подписи, генерацию кода SDK и быстрый поиск API. Это позволяет просматривать запрос, ответ и автоматически сгенерированные примеры.
...
| --- | --- | --- | --- |
| Action | Да | String | [Общие параметры](https://www.tencentcloud.com/document/api/1041/33628). Значение, используемое для этого API: DeleteQualityControlTemplate. |
...
| Definition | Да | Integer | Уникальный идентификатор шаблона проверки качества медиа. |
...
### Пример 1. Удаление шаблона проверки качества медиа
...
---
*Источник: [https://www.tencentcloud.com/document/product/1041/64712](https://www.tencentcloud.com/document/product/1041/64712)*

---
*Источник (EN): [deletequalitycontroltemplate.md](./deletequalitycontroltemplate.md)*

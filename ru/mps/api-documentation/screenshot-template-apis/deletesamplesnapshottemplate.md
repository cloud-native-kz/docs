...
Этот API используется для удаления пользовательского шаблона снимков выборочного экранирования.
...
API Explorer предоставляет различные возможности, включая онлайн-вызов, аутентификацию подписи, генерацию кода SDK и быстрый поиск API. Это позволяет просматривать запрос, ответ и автоматически сгенерированные примеры.
...
| --- | --- | --- | --- |
| Action | Да | String | [Общие параметры](https://www.tencentcloud.com/document/api/1041/33628). Значение для этого API: DeleteSampleSnapshotTemplate. |
...
| Definition | Да | Integer | Уникальный ID шаблона снимков выборочного экранирования. |
...
### Example1 Удаление шаблона снимка экрана выборочного экранирования
...
---
*Источник: [https://www.tencentcloud.com/document/product/1041/33665](https://www.tencentcloud.com/document/product/1041/33665)*

---
*Источник (EN): [deletesamplesnapshottemplate.md](./deletesamplesnapshottemplate.md)*

...
| userIDList | Array | Список значений `userID` друзей, которых нужно добавить в группу |
...
Можно получить группы друзей, кэшированные в SDK. Когда группа друзей обновляется, SDK доставляет событие `TencentCloudChat.EVENT.FRIEND_GROUP_LIST_UPDATED`.
...
| --- | --- | --- |
| name | String | Имя группы |
| userIDList | Array | Список значений `userID` друзей, которых нужно добавить |
...
| --- | --- | --- |
| name | String | Имя группы |
| userIDList | Array | Список значений `userID` друзей, которых нужно удалить |
...
---
*Источник: [https://trtc.io/document/49566](https://trtc.io/document/49566)*

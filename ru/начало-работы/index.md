...
- [Ориентация в консоли](./console-overview.md) — знакомство с интерфейсом консоли
- [Первые шаги после входа](./first-steps.md) — рекомендуемые действия после первого входа
...
Прежде чем использовать платные сервисы, необходимо **создать Платёжный аккаунт** (см. [Создание платёжного аккаунта](../биллинг/setup.md)).
